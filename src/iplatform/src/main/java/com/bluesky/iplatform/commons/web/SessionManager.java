...
import com.bluesky.iplatform.commons.exception.SessionTimeoutException;
...
public class SessionManager {
	...
	public SessionManager(HttpSession session) {
		...
		backStack = (Stack) session
				.getAttribute("com.bluesky.commons.web.BackStack");
		if (backStack == null) {
			backStack = new Stack();
			session.setAttribute("com.bluesky.commons.web.BackStack",
					backStack);
		}
		backList = (List) session
				.getAttribute("com.bluesky.commons.web.BackList");
		if (backList == null) {
			backList = new ArrayList();
			session.setAttribute("com.bluesky.commons.web.BackList", backList);
		}
	}
